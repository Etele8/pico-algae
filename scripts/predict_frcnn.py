...
def main():
    ...
    trainable_backbone_layers = int(ckpt_params.get('trainable_backbone_layers', cfg.get('trainable_backbone_layers', 2)))
    detections_per_image = int(cfg.get('detections_per_image', ckpt_params.get('detections_per_image', 300)))
    box_nms_thresh = float(cfg.get('box_nms_thresh', ckpt_params.get('box_nms_thresh', 0.5)))
    anchor_sizes_cfg = ckpt_params.get('anchor_sizes', None)
    aspect_ratios_cfg = ckpt_params.get('aspect_ratios', None)
